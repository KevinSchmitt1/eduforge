...
3. Lists 5-10 test cases mapping to learning objectives
4. Includes hints (not solutions) for tricky parts
5. Provides estimated time to complete (based on {material_density} and {depth})
6. Includes extension/bonus challenges for deeper mastery
